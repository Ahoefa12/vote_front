...
export default function Edit() {
  ...
  const OnNationalityChange = (e: React.ChangeEvent<HTMLInputElement>) =>
  ...
  const onFullProfilePhotoChange = (
      ...
      <div className="Container">
        <form onSubmit={handleSubmit}>
          ...
          <Input
            ...
            type="text"
            placeholder="Précisez la natinalité du candidat"
          ...
          <Input
            ...
            reference="age"
            type="number"
            placeholder="Veuillez renseigner l'âge du candidat"
          ...
          <Input
            ...
            reference="weight"
            type="number"
            placeholder="Veuillez renseigner le poids du candidat"
          ...
          <Input
            ...
            reference="height"
            type="number"
            placeholder="Veuillez renseigner la taille du candidat"
          ...
          <textarea
            ...
            placeholder="Donnez une briève description du candidat"
          />
          <textarea
          ...
          <Button className="but" label="Mettre à jour" type="submit" />
        </form>
      </div>
    </div>
  );
