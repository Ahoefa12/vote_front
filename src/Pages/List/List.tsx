                            ...
                            candidats.map((candidat, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="btn-cell">
                                        ...
                                        <button className="btn btn-delete" onClick={() => handleDestroyCandidat(candidat.id)}>
                                        ...
                                        <button className="btn btn-edit" onClick={() => handleEditCandidat(candidat.id)}>
                                        ...
                                        <button className="btn btn-details" onClick={() => handleShowCandidat(candidat.id)}>
